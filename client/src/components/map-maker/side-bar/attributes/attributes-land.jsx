...
class AttributesLand extends Component{
    ...
    render(){
        ...
        let textureDropdownId = this.props.select ? "select-land-texture-dropdown" : "land-texture-dropdown";
                ...
                {form}
                 <div className="attribute-items">
                     ...
                     <div className="attribute-row" id={textureContainerID}>
                         ...
                         <div id={textureDropdownId} name={this.state.textureName} className="dropdown-display" style={{backgroundImage:this.state.backgroundImage}} onClick={this.texturesClicked.bind(this)}>
                             {textures}
                         </div>
                     </div>
                     <div className="attribute-row">
